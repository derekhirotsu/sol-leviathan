...
public class Explosive : MonoBehaviour {
    ...
    protected ExplosionAudio explosionAudio;

    protected bool configured = false;
    protected ExplosiveAttackConfig config;
    protected DamageSource damageSource;
    public void Configure(ExplosiveAttackConfig newConfig, DamageSource source) {
        config = newConfig;
        damageSource = source;
